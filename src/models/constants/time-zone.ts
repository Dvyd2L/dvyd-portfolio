 ...
 * Este objeto proporciona abreviaturas para zonas horarias globales, 
 * facilitando la gestión y visualización de información de tiempo en diversas regiones. 
 * Incluye zonas horarias para América del Norte, Europa, Asia, Australia, África y Sudamérica, 
 * además de otras zonas globales significativas. 
 * Cada entrada vincula un identificador de zona horaria IANA con su abreviatura común. 
 * Fuente de algunos datos de zona horaria: 
 * https://www.healthstream.com/hlchelp/Administrator/Classes/HLC_Time_Zone_Abbreviations.html
 */
export const HLC_Time_Zone_Abbreviations: { [key: string]: string } = {
